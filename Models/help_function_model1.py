...
class Dhaka:
    """
    Give the basic information of Dhaka
    """
    def __init__(self, population:int, airportCatchment:int, internationalTraveller: int):
        # Population of Dhaka
        self.population = population
        # Catchment population in Dhaka international airport 
        self.airportCatchment = airportCatchment
        # Total volume of international travel from Dhaka over last two month (Nov-Dec) per day
    ...
    def _calculate_probability_internationalTravel(self):
        ...
        daily outbound international traveller from Dhaka / catchment population of Dhaka airport
        """
...
Daily International passengers travelling out of Dhaka: {self.Dhaka.internationalTraveller}
Effective catchment population of Dhaka Interntional Airport: {self.Dhaka.airportCatchment}

Estimated number of cases in Dhaka: {self.calculate_total_cases_inDhaka()}
Estimated 95% confidence interval: {self.calculate_conf_interval()}

------------------------------------------------------------------------------------
"""
    
    def calculate_total_cases_inDhaka(self):
        """
        total_cases_inDhaka = 
    ...
    def calculate_pro_detected_overseas(self):
       ...
       """
       return self.Dhaka.internationalTravelPro * self.coronavirus.detection
    ...
    def calculate_conf_interval(self, alpha=0.05):
        ...
        n_est = self.calculate_total_cases_inDhaka()
...
class Estimate_Period:
    collect: List[Estimate_Dhaka_case] # collect time series
        
        
def sensitivity_analysis(date: str, Dhaka_population: int,
                        airportCatchment: int, international_case: int, onsetTodetection: int,
                        incubation=6, internationalTraveller=3301):
    """
    Sensitivity analysis to estimate current cases in Dhaka based on 3 scenario
    1. Baseline
    2. Smaller catchment:
        airportCatchment = Dhaka_population
    ...
    for scenario in scenarios:
        ...
        Dhaka_case = Estimate_Dhaka_case(model_name = scenario, date = date, 
                                Dhaka = Dhaka(population=Dhaka_population, 
